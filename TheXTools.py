#### TheXTools Ver PowerFull hehe
###Walaupun script yg saya buat masih ver 1:)
### SUBSCRIBE CHANNEL The X Queens!!
##Jangan di ganti nanti error
##
import os
import sys
from time import sleep as timeout
from core.TheXcore import *
os.system("clear")
##########################
C = '\033[035m'
A = '\033[037m'
...
F = '\033[032m'
#######################################
#    TINGGAL PAKE APA SUSAH NYA?

###########################

def main():
	banner()
	print G+ "   [01] Information Gathering"
	print    "   [02] Vulnerability Scanner"
	print    "   [03] Stress Testing"
	print    "   [04] Password Attacks"
	print    "   [05] Web Hacking"
	print A+ "   [06] Exploitation Tools"
	print    "   [07] Sniffing & Spoofing"
        print    "   [08] Other"
        print    "   [09] Script By The X Queens [Ver.1]"
        print D+ "   [10] Keluar dari tools\n"
	TheXTools = raw_input("TheX > ")
	
	if TheXTools == "1" or TheXTools == "01":
                print F+ "[*]Pilih tools yang ingin di install[*]"
	        print     "[*]SUBSCRIBE CHANNEL The X Queens[*]"
          	print G+ "\n    [01] Nmap"
		print    "    [02] Red Hawk"
		print    "    [03] D-Tect"
		print    "    [04] sqlmap"
		...
		print    "    [31] Mac-Lookup"
		print    "    [32] BillCypher\n"
		print D+ "    [00] Kembali ke menu\n"
		infogathering = raw_input("TheX > ")
	...
	elif TheXTools == "2" or TheXTools == "02":
                print F+ "[*]Pilih yools yang ingin di install[*]"
                print      "[*]SUBSCRIBE CHANNEL The X Queens[*]"
		print G+ "\n    [01] Nmap"
	...
	elif TheXTools == "3" or TheXTools == "03":
                print F+ "[*]Pilih tools yang ingin di install[*]"
                print      "[*]SUBSCIBE CHANNEL The X Queens[*]"
		print G+ "\n    [01] Torshammer"
		print     "    [02] Slowloris"
		print    "    [03] Fl00d & Fl00d2"
		print   "    [04] GoldenEye"
		print  "    [05] Xerxes"
		print E+ "    [06] Planetwork-DDOS"
		print  "    [07] Hydra"
	...
	elif TheXTools == "4" or TheXTools == "04":
                print F+ "[*]Pilih tools yang ingin di install[*]"
                print      "[*]SUBSCRIBE CHANNEL The X Queens[*]"
		print G+ "\n    [01] Hydra"
		print "    [02] FMBrute"
	...
	elif TheXTools == "5" or TheXTools == "05":
		print F+ "[*]Pilih tools yang ingin di install[*]"
		print    " [*]SUBSCRIBE CHANNEL The X Queens[*]"
		print G+ "\n    [01] sqlmap"
		print "    [02] Webdav"
	...
	elif TheXTools == "6" or TheXTools == "06":
		print F+ "[*]Pilih tools yang ingin di install[*]"
		print    "[*]SUBSCRIBE CHANNEL The X Queens[*]"
		print G+ "\n    [01] Metasploit"
		print "    [02] commix"
	...
	elif TheXTools == "7" or TheXTools == "07":
		print G+ "[*]Pilih tools yang ingin di install[*]"
		print     "[*]SUBSCRIBE CHANNEL The X Queens[*]"
		print D+ "\n    [01] KnockMail"
		print "    [02] Spammer-Grab"
		print "    [03] Hac"
		print "    [04] Spammer-Email"
		print E+ "    [05] SocialFish"
		print "    [06] santet-online"
		print "    [07] SpazSMS"
		print "    [08] LiteOTP"
		print F+ "    [09] ASU\n"
		print    "    [00] Kembali Ke Menu\n"
		sspoof = raw_input("TheX > ")
	...
	elif TheXTools == "8" or TheXTools == "08":
		print F+ "[*]Pilih tools yang ingin di install[*]"
		print     "[*]SUBSCRIBE CHANNEL The X Queens[*]"
		print G+ "\n    [01] SpiderBot"
		print "    [02] Ngrok"
        ...
        elif TheXTools == "9" or TheXTools == "09":
                print F+ "[*]Pilih tools yang ingin dipasang[*]"
                print      "[*]SUBSCRIBE CHANNEL The X Queens[*]"
                print E+ "\n [01] TermuxFitur"
                print    " [02] Wifi_Plugin"
                print    " [03] T-LOAD"
                print    " [04] FBhack"
                print    " [05] TheXTools"
                print D+ " [10] Keluar dari tools"
                ScriptByTheX = raw_input("TheX > ")
                
                if ScriptByTheX == "01" or ScriptByTheX == "1":
			termuxfitur()
                elif ScriptByTheX == "02" or ScriptByTheX == "2":
			wifiplugin()
                elif ScriptByTheX == "03" or ScriptByTheX == "3":
			tload()
                elif ScriptByTheX == "04" or ScriptByTheX == "4":
			fbhack()
                elif ScriptByTheX == "05" or ScriptByTheX == "5":
			thextools()
               	elif ScriptByTheX == "00" or ScriptByTheX == "0":
			restart_program()
		else:
                        print "\nERROR: Salah Ngetik"
                        timeout(2)
